        ...
        <div class="auto-margin" id="rblock">
            ...
            <table class="no-letter-spacing">
                <tr>
                    <td>
                        1
                        <input type="checkbox" name="radius" class="rb" id="r_1" value="1" my-title="1"
                               onclick="setRadius(r_1.value)">
                    </td>
                    <td>
                        1.5
                        <input type="checkbox" name="radius" class="rb" id="r_1_5" value="1.5" my-title="1.5"
                               onclick="setRadius(r_1_5.value)">
                    </td>
                    <td>
                        2
                        <input type="checkbox" name="radius" class="rb" id="r_2" value="2" my-title="2"
                               onclick="setRadius(r_2.value)">
                    </td>
                    <td>
                        2.5
                        <input type="checkbox" name="radius" class="rb" id="r_2_5" value="2.5" my-title="2.5"
                               onclick="setRadius(r_2_5.value)">
                    </td>
                    <td>
                        3
                        <input type="checkbox" name="radius" class="rb" id="r_3" value="3" my-title="3"
